...
int ESP8266_Logger::regLogDestSerial(LogLevel logLev, LogSerial logSer) {
...
int ESP8266_Logger::regLogDestWifi(LogLevel logLev, String logHost, String logPort, String logURL,
...
void ESP8266_Logger::log(int logDestIdx, LogLevel logLev, String LogFct, String logStr, boolean prtln) {
...
void ESP8266_Logger::log(LogLevel logLev, String LogFct, String logStr, boolean prtln) {
  int     i        = 0;
